...
<head>
  ...
  <title>larshop @yield('title')</title>
  <link rel="stylesheet" type="text/css" href="{{ asset('polished.min.css') }}">
  <!-- <link rel="stylesheet" href="{{asset('open2-iconic-bootstrap.min.css')}}"> -->
...
<body>
    ...
    <nav class="navbar bg-primary-dark navbar-expand p-0">
      <a class="navbar-brand text-center col-xs-12 col-md-3 col-lg-2 mr-0" href="{{route('users.index')}}">
